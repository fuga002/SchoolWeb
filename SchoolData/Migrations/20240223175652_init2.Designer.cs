...
namespace SchoolData.Migrations
{
    ...
    [Migration("20240223175652_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolData.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("560da73e-9277-49bc-a9d1-91336802a7e4"),
                            BornDate = "2002-31-10",
                            CreatedDateTime = new DateTime(2024, 2, 23, 22, 56, 52, 187, DateTimeKind.Local).AddTicks(3222),
                            FirstName = "Maruf",
                            LastName = "Berdiev",
            ...
            modelBuilder.Entity("SchoolData.Entities.TaskResponseResult", b =>
                {
                    b.HasOne("SchoolData.Entities.TaskResponse", "TaskResponse")
                        .WithMany("Results")
